...
def sales_graph():
    ...
    plt.figtext(0.5, 0.01, f'Total Sold Today: {total_quantity}', ha='center', fontsize=12, color='green')
...
showinfo.add_separator()
showinfo.add_command(label="Expire Date List")
showinfo.add_separator()
showinfo.add_command(label="sales")
